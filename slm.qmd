...
![**Figure:** Model size evolution from 2018-2025 (logarithmic scale). Large language models grew from 0.1B to 1.7 trillion parameters, while small language models emerged in 2023, optimizing performance at 3-10B—achieving comparable results at 100× smaller scale.](images/model-size.png){fig-align="center" width="800"}
