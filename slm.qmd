...
**Latency:** It’s not just about cost—it’s about speed. A local SLM can reply in **under 200 milliseconds**. A cloud LLM often takes 1–3 seconds. In customer service, that lag is the difference between a snappy conversation and a frustrating wait.        
