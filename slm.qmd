...
![**Figure:** LoRA (Low-Rank Adaptation) trains small adapter layers instead of the entire model, achieving 10× faster fine-tuning. A bank can adapt a model for loan applications in hours instead of weeks.](images/LoRA.png){fig-align="center" width="700"}
