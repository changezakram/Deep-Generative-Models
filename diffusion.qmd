...
::: {.callout-note appearance="simple"}
**Diffusion Path Summary**

$$
x_0 \rightarrow x_1 \rightarrow x_2 \rightarrow \ldots \rightarrow x_T
$$

The full diffusion process adds noise step-by-step from $x_0$ to $x_T$.  
But using the marginal distribution, we can jump directly from $x_0$ to any $x_t$ without simulating every intermediate step.
:::
