## Forward Diffusion (with Detailed Derivation)

\subsection*{What is the Forward Diffusion Process?}
...
\subsection*{Step 1: Start with a Data Sample}
...
\subsection*{Step 2: Add Noise Recursively}
...
\subsection*{Step 3: The Markov Chain}
...
\subsection*{Step 4: Deriving the Marginal Distribution $q(x_t \mid x_0)$}
...
\subsection*{Step 6: What Happens as $t$ Gets Large?}
...
\subsection*{Analogy: The Smoothie}
