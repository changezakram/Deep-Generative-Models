...
**Intuition:** Each step shrinks the previous value a bit and adds some Gaussian noise. As you repeat this, the sample becomes more and more like random noise.
:::
...
- Thanks to properties of Gaussian noise, you can always describe the result as a faded original plus a single chunk of noise.
