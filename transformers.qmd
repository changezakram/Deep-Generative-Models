...
Instead of computing a single set of $Q$, $K$, $V$, the model projects the input into $h$ different sets of $Q$, $K$, $V$, called *heads*.  
Each head performs scaled dot-product attention independently, and their outputs are concatenated and linearly transformed.
