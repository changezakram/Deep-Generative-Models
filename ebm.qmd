...
Energy-Based Models use the same framework we've built above — defining a flexible score function $f_\theta(x)$ and converting it into a probability via exponentiation and normalization.
...
This formulation gives EBMs the freedom to use any differentiable function for $f_\theta(x)$ without requiring invertibility or autoregressive factorization.
