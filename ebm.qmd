...
- 📓 [View Notebook on GitHub](https://github.com/yourusername/Deep-Generative-Models/blob/main/ebm_mnist.ipynb)  
- 🚀 [Run in Google Colab](https://colab.research.google.com/github/yourusername/Deep-Generative-Models/blob/main/ebm_mnist.ipynb)
