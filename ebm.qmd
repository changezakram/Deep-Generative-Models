...
1. **Learning a scoring function** (energy) where it assigns low energy to likely data ($x \sim p_{data}$), and high energy to noise.

![Energy field visualization](images/energy_field.png)
<p align="center">
  <img src="images/energy_field.png" alt="Energy Field" width="500"/>
</p>
