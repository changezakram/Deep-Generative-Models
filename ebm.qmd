...
EBMs are trained to assign higher scores (lower energy) to correct data points, and lower scores (higher energy) to incorrect ones. This corresponds to **maximizing the likelihood** of training data.
