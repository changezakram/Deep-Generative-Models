...
![Visualization of the energy function capturing dependency between \( x \) and \( y \)](https://atcold.github.io/NYU-DLSP20/assets/images/energy-function.png)

<p class="caption" style="font-size: 0.85em; color: #666;">
  Source: <a href="https://atcold.github.io/NYU-DLSP20/en/week07/07-1/" target="_blank">Atcold, NYU Deep Learning SP20</a>. The energy function is low (dark blue) where \( x \) and \( y \) are compatible, high (yellow) where they are not.
</p>
