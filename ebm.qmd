...
1. **Learning a scoring function** (energy) where it assigns low energy to likely data ($x \sim p_{data}$), and high energy to unlikely or noisy inputs.
...
![Energy landscape $E(x_1, x_2)$: valleys correspond to likely data, peaks to unlikely inputs.](images/energy_field.png)
