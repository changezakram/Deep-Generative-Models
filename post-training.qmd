...
|--------------------------|------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|
| Instruction Finetuning   | Train LLMs to follow diverse instructions such as summarization, classification, QA, and creative writing. Enables zero-/few-shot generalization across task types. | Improves generalization and alignment<br>Makes outputs more helpful and controllable               | Requires large, curated datasets<br>Open-ended tasks are hard to evaluate<br>Can reflect human bias |
