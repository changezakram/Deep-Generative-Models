...
## Overview: From Language Models to Assistants

This post explores how large pretrained language models (foundation models) can be adapted into useful assistants through post-training techniques, including prompting, instruction finetuning, and human feedback alignment. These steps are critical in transforming general-purpose models like GPT into trustworthy and effective AI tools.

## 1. Prompting: Zero-Shot and Few-Shot In-Context Learning
