...
- **Core Idea**: Encode and reconstruct input using latent variables.
- **Likelihood**: Approximate (ELBO).
- **Sampling**: Fast — sample latent & decode.
- **Use Cases**: Representation learning, image generation.
...
- **Core Idea**: Generator vs. discriminator in a minimax game.
- **Likelihood**: None (implicit).
- **Sampling**: Fast — sample latent & generate.
...
- **Core Idea**: Factor joint distribution conditionally.
- **Likelihood**: Exact.
- **Sampling**: Slow — token-by-token.
- **Use Cases**: Language modeling, code, time series.
- **Examples**: GPT, PixelRNN
:::

::: {.card}
#### Normalizing Flows
- **Core Idea**: Invertible transforms using change-of-variable.
- **Likelihood**: Exact & tractable.
- **Sampling**: Fast — invert base distribution.
- **Use Cases**: Density estimation, latent space modeling.
...
- **Core Idea**: Assign energy; lower = higher probability.
- **Likelihood**: Unnormalized.
- **Sampling**: Very slow — MCMC/Langevin.
- **Use Cases**: Uncertainty modeling, compositional generation.
...
::: {.card}
#### Diffusion Models
- **Core Idea**: Denoise gradual noise to reconstruct.
- **Likelihood**: Approximate.
- **Sampling**: Slow — reverse diffusion steps.
- **Use Cases**: High-res image & audio generation.
