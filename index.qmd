...
> Includes deployments by JPMorgan, Mastercard, Wells Fargo, and Morgan Stanley. [View full Banking use cases →](gen-ai-use-cases/banking-use-cases.html)
...
> Highlights include work by Nuance (Microsoft), Mayo Clinic, DeepMind, and Insilico Medicine. [View full Healthcare use cases →](gen-ai-use-cases/healthcare-use-cases.html)
