...
**6 use cases** across fraud detection, BI, underwriting, and marketing  
Includes JPMorgan, Mastercard, Wells Fargo, Morgan Stanley

### 2. [Healthcare](gen-ai-use-cases/healthcare-use-cases.qmd) 
**5 use cases** from scribing, imaging, triage, to drug discovery  
Based on Nuance, Mayo Clinic, DeepMind, Insilico