...
VAEs compress data into a compact representation (the "latent space"), then reconstruct it. They use a technique called ELBO (Evidence Lower Bound) to approximate the data distribution efficiently.    
