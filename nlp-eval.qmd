...
- MMLU has emerged as a **standardized yardstick** for evaluating foundational knowledge across domains  
- It supports **direct accuracy-based comparisons** between models of different sizes and architectures  
- Performance gains have been dramatic—rising from **~25% (random guessing)** to over **90% accuracy** in just four years  

> **Note**: While MMLU is often used as shorthand for “general intelligence,” this framing can be misleading. MMLU captures **factual recall and pattern recognition**, not necessarily reasoning or abstraction. These limitations will be discussed in later sections.
