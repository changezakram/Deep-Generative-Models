...
> **Quick Reference: Common Evaluation Metrics**
> 
...
>
> - **Exact Match (EM)**: Binary metric—was the predicted output *exactly* the same as the reference answer?
>
> - **AUC-ROC**: Measures ability to distinguish between classes across thresholds.  
