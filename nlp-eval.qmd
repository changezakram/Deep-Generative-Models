...
- **Traditional (Quality Estimation Models)**: Early methods trained separate models (e.g., fine-tuned BERT or regression models) to predict output quality, using features like fluency, coherence, and adequacy. These models require annotated training data but can generalize across tasks.

- **Modern (LLM-Based Evaluation)**: Recent approaches use large language models like GPT-4 to evaluate generations directly. The LLM acts as a judge, scoring output quality based on prompts or evaluation rubrics.
  ...
  - These methods show:
    - **Surprisingly strong agreement with human judgments**
    - **Lower variance than human evaluators**
    - **High scalability** — up to 100× cheaper than human annotation

> **Note**: GPT-4 often shows *higher agreement with human preferences than humans do with each other*, due to its consistency and lack of annotator noise.
...
[12] Celikyilmaz, A., et al. (2020). Evaluation of Text Generation: A Survey. https://arxiv.org/abs/2006.14799

[13] Krishna, K., et al. (2023). LongEval: Guidelines for Human Evaluation of Faithfulness in Long-form Summarization. https://aclanthology.org/2023.eacl-main.121.pdf
