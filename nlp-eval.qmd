...
Core quality aspects commonly assessed include:
...
Despite its importance, human evaluation faces serious practical and methodological challenges.

**Reproducibility Problem**  
A large-scale review of NLP papers (2015–2020) revealed:

- Only **~5%** of studies provided enough methodological detail to replicate the human evaluation  
- *Issues included*: Missing annotator instructions, inconsistent scoring procedures, and unavailable data  
- *Impact*: Undermines scientific rigor and prevents meaningful comparison across studies  
