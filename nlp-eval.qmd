...
- Classification tasks → Traditional metrics (accuracy, F1)
- Text generation → Model-based metrics (BERTScore, BLEURT) 
- High-stakes applications → Human evaluation + LLM validation
- Production monitoring → Fast automated metrics with periodic human checks
