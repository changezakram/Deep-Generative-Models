...
This widely-used benchmark illustrates the reference quality problem in real-world evaluation.

**Dataset Creation:**

- Collected CNN news articles with bullet-point highlights  
- Used highlights as “gold standard” summaries  
- Trained and evaluated summarization models against these references  

**Problems Discovered:**

- Highlights written by journalists under time pressure  
- Often incomplete, poorly structured, or inconsistent  
- Emphasize surface details rather than summary-worthy content  
- Don’t reflect what users actually want  

**Experimental Evidence:**  
Researchers compared evaluation outcomes using:

1. **Original references:** CNN highlights  
2. **Expert references:** Carefully crafted summaries by trained annotators  

**Results:**

- **Original references**: ROUGE showed **near-zero correlation** with human quality ratings  
- **Expert references**: ROUGE achieved **strong correlation** (r = 0.6–0.7)  

**Implication:**  
The metric wasn’t broken—the reference was. Poor references undermine evaluation reliability.

#### Broader Challenges with Reference-Based Evaluation

Even beyond CNN/Daily Mail, reference quality issues are widespread across NLP benchmarks. Common problems include:

- **Sparse or Limited References**: Many tasks only include a single reference, despite the existence of many valid outputs  
- **Stylistic or Tonal Inconsistency**: Differences in formality, phrasing, or verbosity can affect n-gram or model-based scores  
- **Misalignment with Task Objective**: References may emphasize different information than what users or the task demands  
- **Noisy or Imperfect Texts**: Crowdsourced or time-constrained references often include grammar issues, ambiguity, or shallow reasoning  
...
[11] van der Lee, C., et al. (2020). Human Evaluation of Automatically Generated Text: Current Trends and Best Practice Guidelines. https://www.researchgate.net/publication/347355146_Human_evaluation_of_automatically_generated_text_Current_trends_and_best_practice_guidelines

[12] Krishna, K., et al. (2023). LongEval: Guidelines for Human Evaluation of Faithfulness in Long-form Summarization. https://aclanthology.org/2023.eacl-main.121.pdf

[13] Huyen, C. (2024). *AI Engineering: Building Applications with Foundation Models*. O’Reilly Media.  
