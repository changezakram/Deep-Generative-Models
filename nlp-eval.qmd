...
- **Exact Match (EM)**  
  Binary metric—was the predicted output exactly the same as the reference answer?  
  Particularly useful for closed-ended QA and structured prediction tasks.

- **AUC-ROC**  
  Measures ability to distinguish between classes across thresholds.  
