...
- **Accuracy**: $begin:math:text$(TP + TN) / (TP + TN + FP + FN)$end:math:text$  
  Best for balanced datasets with equal class distribution.

- **Precision**: $begin:math:text$TP / (TP + FP)$end:math:text$  
  High precision means fewer false positives.

- **Recall**: $begin:math:text$TP / (TP + FN)$end:math:text$  
  High recall means fewer false negatives.

- **F1 Score**: $begin:math:text$2 \\cdot (Precision \\cdot Recall) / (Precision + Recall)$end:math:text$  
