...
These metrics evaluate performance on individual labeled tasks and require ground-truth answers:
...
Perplexity measures how "surprised" a model is by text (lower = better at predicting next words). 

Perplexity = 2^(average negative log probability)
