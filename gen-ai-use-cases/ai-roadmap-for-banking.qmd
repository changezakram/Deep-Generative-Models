...
![AI Adoption Roadmap for Banking — A phased approach to move from initial pilots to scaled platforms and enterprise-wide AI capabilities, with governance and model risk management embedded from the start.](images/roadmap){#fig-roadmap fig-align="center" width="800"}
