...
Predictive AI and generative AI solve fundamentally different problems. Most banks don’t struggle with building models—they struggle with integrating them into workflows that actually drive decisions. **Predictive AI models** estimate probabilities—the likelihood of default, fraud, or customer churn—and remain essential for risk-driven decisions. **Generative models**, by contrast, specialize in language and content: they read documents, summarize information, and draft narratives, reducing manual effort.

A banking AI strategy should use each capability where it is strongest. A credit decision, for example, may rely on a predictive risk score. Generative AI then reviews financial statements, highlights key terms, and drafts a credit memo for analyst review. The value comes not from choosing one approach, but from combining them within the same workflow. These roles come together within a single workflow, as shown below.

**Agentic AI** extends this progression from insight to execution. Predictive models inform decisions, and generative AI explains them. Agentic systems can then act—orchestrating and executing multi-step workflows within defined controls. This enables a shift from decision support to automated, end-to-end processes such as loan origination or fraud resolution, while maintaining governance and oversight.

![Distinct Roles, Shared Value — Predictive AI drives decisions, generative AI enables interpretation and interaction, and together they create value when integrated within the same workflow.](images/predictive-gen-agentic-ai.png){#fig-predictive-gen-agentic-ai fig-align="center" width="800"}
...
Across these examples, a consistent pattern emerges: predictive AI handles structured decision-making, while generative AI reduces friction in preparing inputs, interpreting results, and executing follow-up actions. The impact comes from embedding these capabilities within the same workflow. This same pattern sets the foundation for agentic AI, where workflows are not just supported but increasingly executed end-to-end within defined controls.
...
![AI Capability Architecture for Banking — Predictive AI drives decisions, generative AI interprets and communicates insights, and agentic AI enables workflow execution, all supported by a shared data foundation and governed control framework.](images/ai_architecture.png){#fig-ai-architecture fig-align="center" width="800"}
...
![AI Adoption Roadmap for Banking — A phased approach to move from initial pilots to scaled platforms and enterprise-wide AI capabilities, with governance and model risk management embedded from the start.](images/ai-roadmap.png){#fig-ai-roadmap fig-align="center" width="800"}
...
This means AI agents that execute loan origination workflows, monitor borrower covenant compliance, triage commercial banking communications, and run stress testing scenarios—coordinating specialized agents within defined risk and governance boundaries. The distinction from generative AI is operational: agents don't just help bankers work faster, they do structured work independently within policy-governed limits.
