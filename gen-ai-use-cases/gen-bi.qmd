...
**Governance, Consistency, and Reusability in Action**
...
*These principles are emphasized in BI architectures from Microsoft<sup>[5]</sup>, ThoughtSpot<sup>[6]</sup>, and IBM<sup>[7]</sup>.*
