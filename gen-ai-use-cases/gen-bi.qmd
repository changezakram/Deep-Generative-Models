...
Beyond Power BI and ThoughtSpot, several other modern platforms offer semantic modeling capabilities that may play a role in a broader Gen BI ecosystem:

- **dbt Semantic Layer** – integrates with dbt to define metrics as code and expose them for BI/AI use  
- **AtScale** – external semantic layer for governed analytics across tools  
- **Cube.dev** – headless BI platform with semantic APIs for structured access  
- **LookML (Looker)** – defines semantic logic in code and serves both BI and ML tools  
- **Power BI Dataset Model** – Microsoft’s tabular modeling framework for governance and reuse  
:::
