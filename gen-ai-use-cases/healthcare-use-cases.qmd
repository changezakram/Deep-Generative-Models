...
- **Impact**: Google’s Med-PaLM Multimodal can generate radiology-quality X-rays from text prompts<sup>[3]</sup>; DeepMind’s diffusion-based approach improved rare disease classification accuracy on retinal OCT scans<sup>[4]</sup>.
