...
The diagram below illustrates how experience agents, domain agents, and the intelligence layer collaborate in a mortgage underwriting workflow, with humans retaining final approval.
...
The workflow below illustrates how agentic systems compress CCAR stress testing timelines while preserving regulatory oversight.

![**Figure:** L2 stress testing workflow showing experience interface for scenario setup and oversight, intelligence-layer orchestration enforcing policy and risk controls, domain agents executing regulatory stress tests on governed data, and human risk analysts approving final results.](images/Stress-Testing-Agents_.png){fig-align="center" width="800"}

Timelines compress by removing manual handoffs in scenario mapping, data assembly, and model execution—while keeping human approval intact.
